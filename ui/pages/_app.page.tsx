...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp Testnet Mina [Faresa]</title>
        <meta name="description" content="ZkApp By Faresa" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/faresapn" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/826863071385354251" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/faresapn" target="_blank" rel="noopener noreferrer" >
						<span className={styles.gitIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://web.facebook.com/faresaprasetyon" target="_blank" rel="noopener noreferrer" >
